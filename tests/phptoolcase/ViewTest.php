<?php
	...
	final class ViewTest extends TestCase
	{
		...
		{
			View::path( dirname( __FILE__ ) . '/dependencies/views' );
		}
		
		public function testMake( )
		{
			$view = View::make( 'view' , [ 'test' => 'some data' , 'child' => 'some more data' ] );
		...
		{
			$html = View::make( 'view' , [ 'test' => 'some data' , 'child' => 'some more data' ] )
					->compile( );
			$this->assertEquals( 339 , strlen( $html ) );
		...
		{
			ob_start( );
			$html = View::make( 'view' , [ 'test' => 'some data' ] )
					->nest( 'child' , 'nested' , [ 'some' => 'view data' ] )
					->render( );
			$html = ob_get_clean( );
			$this->assertEquals( 361 , strlen( $html ) );
